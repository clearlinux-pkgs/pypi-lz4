...
Source0  : https://files.pythonhosted.org/packages/a4/31/ec1259ca8ad11568abaf090a7da719616ca96b60d097ccc5799cd0ff599c/lz4-4.3.3.tar.gz
...
%prep
%setup -q -n lz4-4.3.3
cd %{_builddir}/lz4-4.3.3
pushd ..
cp -a lz4-4.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704210684
