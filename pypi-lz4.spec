...
Source0  : https://files.pythonhosted.org/packages/cc/bc/b2e79af05be82841706ddd7d78059e5f78e6ca5828f92034394b54e303b7/lz4-4.4.3.tar.gz
...
%prep
%setup -q -n lz4-4.4.3
cd %{_builddir}/lz4-4.4.3
pushd ..
cp -a lz4-4.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737992649
