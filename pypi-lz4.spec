...
Source0  : https://files.pythonhosted.org/packages/8f/cc/cedcd6c25f30e4a72ee9589cd01b9e7c0d427e763e6567e832eb639c443b/lz4-4.2.0.tar.gz
...
%prep
%setup -q -n lz4-4.2.0
cd %{_builddir}/lz4-4.2.0
pushd ..
cp -a lz4-4.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672331508
